...
<section id="faq" class="container">
  ...
  <details><summary>How do users authenticate?</summary><p>Microsoft Entra ID via OIDC, terminated at oauth2-proxy in front of Caddy. MFA applies if your tenant enforces it; admin status comes from membership in a configured Entra security group.</p></details>
